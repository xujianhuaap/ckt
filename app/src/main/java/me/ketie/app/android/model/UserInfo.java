...
public class UserInfo {
    ...
    public UserInfo(Oauth2Access oauth2Access,LoginType loginType,String token,String nickname, String img) {
    ...
    public static UserInfo read(Context context){
        ...
        return new UserInfo(oauth,lType,token,nickname,img);
    }
